...
This repository contains the test done on integrating DJI RS3 pro gimal(hardware) with moveit(software). The complete code cannot be shared because of **copyright issues**. The above code is not complete, I have only shared the testing scripts used to control the axis of gimbal.  

...
int main(int argc, char **argv)
{
    ...
    target_pose1.orientation.x = 0.157;
    target_pose1.orientation.y = 0.049;
    target_pose1.orientation.z = 0.291;
    target_pose1.orientation.w = 0.942;

    target_pose1.position.x = 0.086;
    target_pose1.position.y = 0.110;
    target_pose1.position.z = 1.717;
